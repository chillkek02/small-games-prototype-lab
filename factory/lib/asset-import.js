...
export const ASSET_IMPORT_VERSION='1.0.2';
...
export async function importAsset({gameDir,payload={}}){
  ...
  const sourceData=payload.base64?decodeBase64(payload.base64):null;
  const svgText=!sourceData&&mime==='image/svg+xml'&&payload.svgText?validateSvgText(String(payload.svgText).slice(0,2_000_000)):null;
