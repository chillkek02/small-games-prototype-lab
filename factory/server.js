...
import { isQualityGameActive } from './lib/quality-jobs.js';
...
function gameIsBusy(game){return activeByGame.has(game)||qualityBusy.has(game)||restoreBusy.has(game)||isQualityGameActive(game)}
